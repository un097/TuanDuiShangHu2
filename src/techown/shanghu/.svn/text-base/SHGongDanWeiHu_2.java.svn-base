 ...
 * 商户信息录入
 */
public class SHGongDanWeiHu_2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			MyDatabaseHelper myHelper = new MyDatabaseHelper(
					SHGongDanWeiHu_2.this, "techown.db", Constant.tdshDBVer);
			...
			tv_shPosWorkBZ.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(SHGongDanWeiHu_2.this, linear_poswork,
			...
			tv_shNameBZ.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(SHGongDanWeiHu_2.this, linear_shName,
			...
			tv_shPhoneNumBZ.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(SHGongDanWeiHu_2.this, linear_shPhoneNum,
							tv_shPhoneNumBZ,
			...
			tv_sbNumBZ.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(SHGongDanWeiHu_2.this, linear_sbNum, tv_sbNumBZ,
			...
			tv_sbAdd.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(SHGongDanWeiHu_2.this, linear_sbAdd, tv_sbAdd,
			...
			tv_shAddressBZ.setOnTouchListener(new OnTouchListener() {
				public boolean onTouch(View arg0, MotionEvent arg1) {
					...
					case MotionEvent.ACTION_DOWN:
						log.Dialog(SHGongDanWeiHu_2.this, linear_shAddress,
								tv_shAddressBZ,
				...
				public void onClick(View v) {
					...
					if (sum != 4) {
						...
						tv_item_sbadd.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								log.Dialog(SHGongDanWeiHu_2.this, linear_sbAdd,
						...
						Toast.makeText(SHGongDanWeiHu_2.this, "只能添加5个商编", 0)
								.show();
					}
				}
			});
			...
			if("".equals((tv_sbNum.getText().toString()).trim())){
		...
		if (!requeststr1.equals("")) {
			...
			try {
				...
				if (demoJson1.getString("rspCode").equals("000000")) {
					...
					tempstr1[5] = (demoJson1.getString("misInfoList")).trim();// 商编终端号集合
					tempstr1[6] = (demoJson1.getString("MerSn")).trim();// SN集合
	...
	private void exitTask(final Context con) {
		...
		b.setPositiveButton("是", new DialogInterface.OnClickListener() {// 设置监听事件
					public void onClick(DialogInterface dialog, int which) {
						...
						flagfirst = true;
						SHGongDanWeiHu_3.flagfirst = true;
						// 删除此次工单信息
	...
	public void saveData() {
		try {
			...
			DB.upload2(SHGongDanWeiHu_2.this, "shgongdanweihu",clomname, clomstr,
					SHGongDanWeiHu.num);
		} catch (Exception e) {
			techown.shanghu.https.Log.Instance().WriteLog(
					"HeYueQianDing_2类SaveData（）" + e.getMessage());
		}
	}
		...
		public void onClick(View v) {
			...
			try {
				...
				case R.id.btn_gongdan2_pre:
					exitTask(SHGongDanWeiHu_2.this);
					break;
				...
				case R.id.btn_gongdan2_next:
					if (validate()) {
						flagfirst = true;
						saveData();
						intent.setClass(SHGongDanWeiHu_2.this,
								SHGongDanWeiHu_3.class);
						SHGongDanWeiHu_2.this.startActivity(intent);
						SHGongDanWeiHu_2.this.finish();
	...
	protected boolean validate() {
		...
		if (group_shAddress.getCheckedRadioButtonId() == -1) {
			...
			if ("".equals(tv_shAddressBZ.getText().toString())) {
				log.Toast(SHGongDanWeiHu_2.this, "商户地址是否正确您选择了否，请填写备注 ！");
				return false;
			}
		}

		if (group_shPhoneNum.getCheckedRadioButtonId() == -1) {
			log.Toast(SHGongDanWeiHu_2.this, "请选择商户联系电话是否正确  ！");
			return false;
			...
			for (int i = 0; i < linear_parent_sbAdd.getChildCount(); i++) {
				if(i == 0){
					if ("".equals(tv_sbAdd.getText().toString())) {
						log.Toast(SHGongDanWeiHu_2.this, "请填写完整新增商编终端号 ！");
						return false;
					}
				}else{
					LinearLayout linear = (LinearLayout) linear_parent_sbAdd
