...
public class MendianList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDialog = new AlertDialog.Builder(MendianList.this).create();
		// init();
		...
		LinearLayout view = (LinearLayout) LayoutInflater
				.from(MendianList.this).inflate(R.layout.mendianitemlist, null);
		...
		adapter = new ListAdapter1(MendianList.this, list);
		...
		public void onClick(View v) {
			...
			case R.id.shouye_xd:// 首页
				if (Integer.parseInt(pageNo) == 1) {
					log.Toast(MendianList.this, "已经是首页！");
				} else {
					pageData("1");
			...
			case R.id.xiaye_xd:// 下一页
				if (Integer.parseInt(pageNo) == Integer.parseInt(pageCnt)) {
					log.Toast(MendianList.this, "已经是尾页！");
				} else {
					pageData(String.valueOf(Integer.parseInt(pageNo) + 1));
			...
			case R.id.fanhui_button:
				intent.setClass(MendianList.this, ZhongBuHuoDong1.class);
				MendianList.this.startActivity(intent);
				MendianList.this.finish();
	...
	private void pageData(final String pagerno) {
		...
		new Thread() {
			public void run() {
				...
				str[2] = ZhongBuChaXun4.tempstr1[0];
	...
	private void init() {
		...
		list.clear();
		try {
			JSONObject demoJson1 = new JSONObject(ZhongBuChaXun4.requeststr2);
			...
			if (demoJson1.getString("rspCode").equals("00")) {
				...
				Toast.makeText(MendianList.this,
	...
	class ListAdapter1 extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(view==null){
			LayoutInflater inflater = LayoutInflater.from(MendianList.this);
					...
					new Thread() {
						...
						public void run() {
							...
							String json1 = "{" + "\"merId\":\"" + str1[0]
									+ "\"," + "\"actId\":\"\"}";
							ZhongBuHuoDong31.requeststr1 = HttpConnection2
									.HttpRequest(HttpConnection2.getHttpCon(
											TuanDuiShangHuActivity.indenty,
											"A0010"), json1);
							if (ZhongBuHuoDong31.requeststr1 != null
									&& ZhongBuHuoDong31.requeststr1.length() > 0) {
								try {
									JSONObject demoJson1 = new JSONObject(
											ZhongBuHuoDong31.requeststr1);
									if (demoJson1.getString("rspCode").equals(
											"00")) {
										mDialog.dismiss();
										i.setClass(MendianList.this,
												ZhongBuHuoDong31.class);
										MendianList.this.startActivity(i);
										overridePendingTransition(R.anim.leftin, R.anim.leftout);
										ZhongBuHuoDong31.zhi="shang";
										MendianList.this.finish();
