...
public class YouHuiShangXian_TeHui2_2 extends Activity{
...
//	        	DBUtil.upload(YouHuiShangXian_TeHui2.this, new String[]{"IsNewCompany"}, new String[]{"Y"}, TuanDuiShangHuActivity.num);
	        	...
	        	//Toast.makeText(YouHuiShangXian_TeHui2_2.this, b.getString("throwsmessage"),Toast.LENGTH_LONG).show();
	        	log.Toast(YouHuiShangXian_TeHui2_2.this, b.getString("throwsmessage"));
	        	Intent intent = new Intent();
	        	intent.setClass(YouHuiShangXian_TeHui2_2.this, ZhongBuHuoDong1.class);
...
//	        	DBUtil.upload(YouHuiShangXian_TeHui2.this, new String[]{"IsNewCompany"}, new String[]{"Y"}, TuanDuiShangHuActivity.num);
	        	 ...
	        	 log.Toast(YouHuiShangXian_TeHui2_2.this, b.getString("throwsmessage"));
		        intent = new Intent();
		        intent.setClass(YouHuiShangXian_TeHui2_2.this, ZhongBuChaXun4.class);
		        YouHuiShangXian_TeHui2_2.this.startActivity(intent);
		        YouHuiShangXian_TeHui2_2.this.finish();	
	        	break;	
	        case 5:
...
//				mDialog.dismiss();
			...
			case 7:// 获取gps失败
				...
				log.Toast(YouHuiShangXian_TeHui2_2.this,"GPS获取失败");
				stoptime = System.currentTimeMillis();
				break;
			case 8:
				if(stoptime==0)
				{
					mGPS.close();
					hideWaitingDialog();
					log.Toast(YouHuiShangXian_TeHui2_2.this, "获取GPS超时！");
					stoptime = 0;
				}
				break;
			case 9:// 获取gps失败
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new AlertDialog.Builder(YouHuiShangXian_TeHui2_2.this).create();//连接网络进程
...
//				break;
				case R.id.button3:
					...
					{
						log.Toast(YouHuiShangXian_TeHui2_2.this,"GPS采集错误");
					}   
					else if(textView6.getText().toString().equals("")||textView7.getText().toString().equals(""))
					{
						log.Toast(YouHuiShangXian_TeHui2_2.this,"经纬度不能为空");
					}
					else{
...
//							 mDialog.dismiss();	
					saveData();
					intent.setClass(YouHuiShangXian_TeHui2_2.this, YouHuiShangXian_TeHui4_4.class);
					YouHuiShangXian_TeHui2_2.this.startActivity(intent);
					YouHuiShangXian_TeHui2_2.this.finish();
...
//					}
    	...
    	public void run() {
    		...
    		while(true){
    			...
    			if(currTime - startTime > 300000 && !isGetGps){
    				YouHuiShangXian_TeHui2_2.this.handler.sendEmptyMessage(7);
    				break;
    			}
	    		try{
	    			...
	    			techown.shanghu.https.Log.Instance().WriteLog(
							"YouHuiShangXian_TeHui2_2(1000);"+ e.getMessage());
	    		}
    		}
    	}
    ...
    public void saveData() {
		...
		DB.upload4(YouHuiShangXian_TeHui2_2.this, clomname, clomstr, TuanDuiShangHuActivity.tmpId3);
	}
	 ...
	 private void qushuju() {
			...
			MyDatabaseHelper myHelper = new MyDatabaseHelper( YouHuiShangXian_TeHui2_2.this, "techown.db", Constant.tdshDBVer);
			...
			while (cursor.moveToNext()) {
				try {
					...
					techown.shanghu.https.Log.Instance().WriteLog("YouHuiShangXian_TeHui2_2:qushuju()" + e.getMessage());
				}finally{
					if(cursor!=null){
						cursor.close();
					}if(db!=null){
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			log.ExitApp(YouHuiShangXian_TeHui2_2.this);
			break;
		...
		llistener = new LocationListener() {
			...
			// TODO Auto-generated method stub
				if(arg0 != null){
					...
					YouHuiShangXian_TeHui2_2.this.handler.sendEmptyMessage(6);
				}
