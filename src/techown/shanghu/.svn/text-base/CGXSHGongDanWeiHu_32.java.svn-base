 ...
 * 草稿箱 SN信息录入
 */
public class CGXSHGongDanWeiHu_32 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			MyDatabaseHelper myHelper = new MyDatabaseHelper(
					CGXSHGongDanWeiHu_32.this, "techown.db", Constant.tdshDBVer);
			...
			while (cursor.moveToNext()) {
				try {
					...
					for(int i=0; i<snNumInfo.length;i++){
						if(i==0){
							...
							View view = LayoutInflater.from(
									CGXSHGongDanWeiHu_32.this).inflate(
					...
					techown.shanghu.https.Log.Instance().WriteLog(
							"团队CGXSHGongDanWeiHu_32:" + e.getMessage());
				} finally {
					if (cursor != null) {
						cursor.close();
					}
			...
			tv_machineWorkBZ.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(CGXSHGongDanWeiHu_32.this, linear_machinework,
							tv_machineWorkBZ,
			...
			tv_snNumBZ.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(CGXSHGongDanWeiHu_32.this, linear_snNum, tv_snNumBZ,
			...
			tv_snNumAdd.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(CGXSHGongDanWeiHu_32.this, linear_snNumAdd, tv_snNumAdd,
...
*/
	...
	public void saveData() {
		try {
			...
			DB.upload2(CGXSHGongDanWeiHu_32.this, "shgongdanweihu",clomname, clomstr,
					TuanDuiShangHuActivity.tmpId8);
		} catch (Exception e) {
			techown.shanghu.https.Log.Instance().WriteLog(
					"CGXSHGongDanWeiHu_32类SaveData（）" + e.getMessage());
		}
	}
		...
		public void onClick(View v) {
			...
			try {
				...
				case R.id.btn_gongdan3_pre:
					intent.setClass(CGXSHGongDanWeiHu_32.this,
							CGXSHGongDanWeiHu_22.class);
					CGXSHGongDanWeiHu_32.this.startActivity(intent);
					CGXSHGongDanWeiHu_32.this.finish();
				...
				techown.shanghu.https.Log.Instance().WriteLog(
						"CGXSHGongDanWeiHu()_32类按钮点击：" + e.getMessage());
	...
	protected boolean validate() {
		if(!"".equals(tv_snNum.getText().toString())){
			if (group_machine_wrok.getCheckedRadioButtonId() == -1) {
				log.Toast(CGXSHGongDanWeiHu_32.this, "请选择机具是否正常运作 ！");
				return false;
				...
				if ("".equals(tv_machineWorkBZ.getText().toString())) {
					log.Toast(CGXSHGongDanWeiHu_32.this, "机具是否正常运作您选择了否，请填写备注 ！");
					return false;
				}
			}
		}
