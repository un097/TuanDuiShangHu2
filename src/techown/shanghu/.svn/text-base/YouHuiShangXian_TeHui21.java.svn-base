...
public class YouHuiShangXian_TeHui21 extends Activity {
	...
	Handler handler = new Handler() { //
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				break;
			case 2:
				// DBUtil.upload(YouHuiShangXian_TeHui21.this, new
				// String[]{"IsNewCompany"}, new String[]{"Y"},
				// TuanDuiShangHuActivity.num);

				Bundle b = msg.getData();
				log.Toast(YouHuiShangXian_TeHui21.this,
						b.getString("throwsmessage"));
				// Toast.makeText(YouHuiShangXian_TeHui21.this,
				// b.getString("throwsmessage"),Toast.LENGTH_LONG).show();
				Intent intent = new Intent();
				intent.setClass(YouHuiShangXian_TeHui21.this,
						ZhongBuHuoDong1.class);
				YouHuiShangXian_TeHui21.this.startActivity(intent);
				YouHuiShangXian_TeHui21.this.finish();
				break;
			case 3:
				// DBUtil.upload(YouHuiShangXian_TeHui21.this, new
				// String[]{"IsNewCompany"}, new String[]{"Y"},
...
//				mDialog.dismiss();
			...
			case 7:// 获取gps失败
				...
				log.Toast(YouHuiShangXian_TeHui21.this,"GPS获取失败");
				stoptime = System.currentTimeMillis();
				break;
			case 8:
				if(stoptime==0)
				{
					mGPS.close();
					hideWaitingDialog();
					log.Toast(YouHuiShangXian_TeHui21.this, "获取GPS超时！");
					stoptime = 0;
				}
				break;
			case 9:// 获取gps失败
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mDialog = new AlertDialog.Builder(YouHuiShangXian_TeHui21.this)
				.create();// 连接网络进程
		...
		MyDatabaseHelper myHelper = new MyDatabaseHelper(
				YouHuiShangXian_TeHui21.this, "techown.db", Constant.tdshDBVer);
		...
		while (cursor.moveToNext()) {
			try {
				...
				techown.shanghu.https.Log.Instance().WriteLog(
						"YouHuiShangXian_TeHui21:qushuju()" + e.getMessage());
			} finally {
				if (cursor != null) {
					cursor.close();
				}
	...
	class MyLis implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.button3:
				...
				{
					log.Toast(YouHuiShangXian_TeHui21.this, "GPS采集错误");
				} 
				else if (textView6.getText().toString().equals("")|| textView7.getText().toString().equals("")) 
				{
					log.Toast(YouHuiShangXian_TeHui21.this, "经纬度不能为空");
				}
				else {
					//
					...
					new Thread() {
						public void run() {
							...
							str1[1] = YouHuiShangXian_TeHui.actid2;

							String json1 = "{" + "\"merId\":\"" + str1[0]
									+ "\"," + "\"actId\":\"" + str1[1] + "\"}";

							YouHuiShangXian_ZuiHong3.requeststr1 = HttpConnection2
									.request(json1, "A0010");

							mDialog.dismiss();
							saveData();
							intent.setClass(YouHuiShangXian_TeHui21.this,
									YouHuiShangXian_ZuiHong3.class);
							YouHuiShangXian_TeHui21.this.startActivity(intent);
							YouHuiShangXian_TeHui21.this.finish();
...
//				}
	...
	public void saveData() {
		...
		DB.upload4(YouHuiShangXian_TeHui21.this, clomname, clomstr,
				YouHuiShangXian_TeHui.num);
	}

	public boolean onKeyDown(int keyCode, KeyEvent event) {
		switch (keyCode) {
		case KeyEvent.KEYCODE_BACK:
			log.ExitApp(YouHuiShangXian_TeHui21.this);
			break;
		...
		public void run() {
			...
			while (true) {
				...
				if (currTime - startTime > 300000 && !isGetGps) {
					YouHuiShangXian_TeHui21.this.handler.sendEmptyMessage(7);
					break;
				}
				try {
					...
					techown.shanghu.https.Log.Instance().WriteLog("YouHuiShangXian_TeHui21:1000()" + e.getMessage());
				}
			}
		}
		...
		llistener = new LocationListener() {
			...
			public void onLocationChanged(Location arg0) {
				...
				if (arg0 != null) {
					...
					YouHuiShangXian_TeHui21.this.handler.sendEmptyMessage(6);
				}
