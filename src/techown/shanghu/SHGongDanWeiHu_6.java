 ...
 * 信息确认录入
 */
public class SHGongDanWeiHu_6 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		signPath="TJB/TuanDui/gesturesign/" + SHGongDanWeiHu.num;
		picPath ="TJB/TuanDui/shgongdan/" + SHGongDanWeiHu.num + "/pic/";
		...
		try {
			...
			MyDatabaseHelper myHelper = new MyDatabaseHelper(
					SHGongDanWeiHu_6.this, "techown.db", Constant.tdshDBVer);
			...
			while (cursor.moveToNext()) {
				try {
					...
					techown.shanghu.https.Log.Instance().WriteLog(
							"团队SHGongDanWeiHu_6:" + e.getMessage());
				} finally {
					if (cursor != null) {
						cursor.close();
					}
			...
			tv_princal_name.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					log.Dialog(SHGongDanWeiHu_6.this, linear_princal_name,
			...
			tv_princal_phone.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(SHGongDanWeiHu_6.this, linear_princal_phone,
	...
	public void saveData() {
		try {
			...
			DB.upload2(SHGongDanWeiHu_6.this, "shgongdanweihu", clomname,
					clomstr, SHGongDanWeiHu.num);
		} catch (Exception e) {
			techown.shanghu.https.Log.Instance().WriteLog(
					"HeYueQianDing_6类SaveData（）" + e.getMessage());
		}
	}
		...
		public void onClick(View v) {
			...
			try {
				...
				case R.id.btn_gongdan6_pre:
					intent.setClass(SHGongDanWeiHu_6.this,
							SHGongDanWeiHu_5.class);
					SHGongDanWeiHu_6.this.startActivity(intent);
					SHGongDanWeiHu_6.this.finish();
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			Intent intent = new Intent();
			intent.setClass(SHGongDanWeiHu_6.this, SHGongDanWeiHu_5.class);
			SHGongDanWeiHu_6.this.startActivity(intent);
			SHGongDanWeiHu_6.this.finish();
			overridePendingTransition(R.anim.rightin, R.anim.rightout);
			break;
	...
	protected boolean validate() {
		...
		if ("".equals(tv_princal_name.getText().toString())) {
			log.Toast(SHGongDanWeiHu_6.this, "请填写负责人姓名 ！");
			return false;

		}
		if ("".equals(tv_princal_phone.getText().toString())) {
			log.Toast(SHGongDanWeiHu_6.this, "请填写负责人联系电话 ！");
			return false;
		}
		if(iv_sign.getDrawable()== null){
			log.Toast(SHGongDanWeiHu_6.this, "请负责人进行签名 ！");
			return false;
		}
		return true;
	}
