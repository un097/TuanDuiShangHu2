...
import techown.shanghu.ChengShiChaXun4.MyLis;
...
import techown.shanghu.photo.PictureDialog;
import techown.shanghu.photo.SHGDPictureDialog;
 ...
 * 拍照页面
 */
public class SHGongDanWeiHu_4 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		path = "TJB/TuanDui/shgongdan/" + SHGongDanWeiHu.num + "/pic/";
		createDir(path);
		initView();
		guolaipaizhao();
		mPadUtiltiy = new PadUtiltiy(this);
		mDialog = new AlertDialog.Builder(SHGongDanWeiHu_4.this).create();
		...
		btn_pre.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				SHGongDanWeiHu_3.flagfirst = false;
				intent.setClass(SHGongDanWeiHu_4.this, SHGongDanWeiHu_3.class);
				SHGongDanWeiHu_4.this.startActivity(intent);
				SHGongDanWeiHu_4.this.finish();
		...
		ia = new ImageAdapter(SHGongDanWeiHu_4.this, picname, picbim);
		imagList.setAdapter(ia);
		imagList.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				SHGDPictureDialog editDlg = new SHGDPictureDialog(
						SHGongDanWeiHu_4.this, ia.mbit[arg2],
						ia.mItemList[arg2]);
		...
		public void onClick(View v) {
			...
			case R.id.btn_gongdan4_next:// next
				if (validate()) {
					uploadname();
					Intent intent = new Intent();
					intent.setClass(SHGongDanWeiHu_4.this,
							SHGongDanWeiHu_5.class);
					SHGongDanWeiHu_4.this.startActivity(intent);
	...
	public void saveFile(String filepath, String fileName, int num) {
		try {
			...
			techown.shanghu.https.Log.Instance().WriteLog(
					"团队SHGongDanWeiHu_4:" + e.getMessage());
		}
	...
	private void guolaipaizhao() {
		...
		try {
			MyDatabaseHelper myHelper = new MyDatabaseHelper(
					SHGongDanWeiHu_4.this, "techown.db", Constant.tdshDBVer);
	...
	private void uploadname() {
		...
		if (picname != null && picname.length > 0) {
			...
			DB.upload2(SHGongDanWeiHu_4.this, "shgongdanweihu", new String[] {
					"doorPicName", "tablePicName", "checkPicName" },
					new String[] { nameone, nametwo, namethree },
					SHGongDanWeiHu.num);
		}
	}
	...
	public boolean validate() {
		...
		if (!btn_pic_entry.getText().toString().equals("入口区拍摄(已拍)")) {
			log.Toast(SHGongDanWeiHu_4.this, "请拍摄入口区照片！");
			return false;
		}
		if (!btn_pic_table.getText().toString().equals("餐桌区拍摄(已拍)")) {
			log.Toast(SHGongDanWeiHu_4.this, "请拍摄餐桌区照片！");
			return false;
		}
		if (!btn_pic_check.getText().toString().equals("收银区拍摄(已拍)")) {
			log.Toast(SHGongDanWeiHu_4.this, "请拍摄收银区照片！");
			return false;
		}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			//log.ExitApp(SHGongDanWeiHu_4.this);
			exitTask(SHGongDanWeiHu_4.this);
			break;
