 ...
 * 培训信息录入
 */
public class SHGongDanWeiHu_5 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			MyDatabaseHelper myHelper = new MyDatabaseHelper(
					SHGongDanWeiHu_5.this, "techown.db", Constant.tdshDBVer);
			...
			while (cursor.moveToNext()) {
				try {
					...
					techown.shanghu.https.Log.Instance().WriteLog(
							"团队SHGongDanWeiHu_5:" + e.getMessage());
				} finally {
					if (cursor != null) {
						cursor.close();
					}
			...
			tv_target_bz.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					log.Dialog(SHGongDanWeiHu_5.this, linear_train_target,
			...
			tv_content_bz.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					log.Dialog(SHGongDanWeiHu_5.this, linear_train_content,
	...
	public void saveData() {
		try {
			...
			DB.upload2(SHGongDanWeiHu_5.this, "shgongdanweihu",clomname, clomstr,
					SHGongDanWeiHu.num);
		} catch (Exception e) {
			techown.shanghu.https.Log.Instance().WriteLog(
		...
		public void onClick(View v) {
			...
			try {
				...
				case R.id.btn_gongdan5_pre:
					intent.setClass(SHGongDanWeiHu_5.this,
							SHGongDanWeiHu_4.class);
					SHGongDanWeiHu_5.this.startActivity(intent);
					SHGongDanWeiHu_5.this.finish();
	...
	protected boolean validate() {
		...
		if(!cb_target_cashier.isChecked() && !cb_target_manager.isChecked() && !cb_target_sericer.isChecked()){
			...
			if("".equals(tv_target_bz.getText().toString())){
				log.Toast(SHGongDanWeiHu_5.this, "培训对象未全选时需填写备注！");
				return false;
			}
		...
		if(!cb_content_one.isChecked() && !cb_content_two.isChecked() && !cb_content_three.isChecked()&& !cb_content_four.isChecked()){
			log.Toast(SHGongDanWeiHu_5.this, "请选择培训内容！");
			return false;
		}
		
		if("".equals(tv_content_bz.getText().toString())){
			log.Toast(SHGongDanWeiHu_5.this, "请填写培训内容备注！");
			return false;
		}
