...
public class YouHuiShangXian_TeHui2 extends Activity{
...
//	        	 log.Toast(YouHuiShangXian_TeHui2.this, b.getString("throwsmessage"));
	        	Toast.makeText(YouHuiShangXian_TeHui2.this, b.getString("throwsmessage"),Toast.LENGTH_LONG).show();
	        	Intent intent = new Intent();
	        	intent.setClass(YouHuiShangXian_TeHui2.this, ZhongBuHuoDong1.class);
	        	YouHuiShangXian_TeHui2.this.startActivity(intent);
	        	YouHuiShangXian_TeHui2.this.finish();
	        	break;
	        case 3:
//	        	DBUtil.upload(YouHuiShangXian_TeHui2.this, new String[]{"IsNewCompany"}, new String[]{"Y"}, TuanDuiShangHuActivity.num);
	        	 b = msg.getData();
...
//	        	DBUtil.upload(YouHuiShangXian_TeHui2.this, new String[]{"IsNewCompany"}, new String[]{"Y"}, TuanDuiShangHuActivity.num);
	        	 ...
	        	 log.Toast(YouHuiShangXian_TeHui2.this, b.getString("throwsmessage"));
		        intent = new Intent();
		        intent.setClass(YouHuiShangXian_TeHui2.this, ZhongBuChaXun4.class);
		        YouHuiShangXian_TeHui2.this.startActivity(intent);
		        YouHuiShangXian_TeHui2.this.finish();	
	        	break;	
	        case 5:
...
//				mDialog.dismiss();
			...
			case 7:// 获取gps失败
				...
				log.Toast(YouHuiShangXian_TeHui2.this,"GPS获取失败");
				stoptime = System.currentTimeMillis();
				break;
			case 8:
				if(stoptime==0)
				{
					mGPS.close();
					hideWaitingDialog();
					log.Toast(YouHuiShangXian_TeHui2.this, "获取GPS超时！");
					stoptime = 0;
				}
				break;
			case 9:// 获取gps失败
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDialog = new AlertDialog.Builder(YouHuiShangXian_TeHui2.this).create();//连接网络进程
      ...
      //读取数据
		  MyDatabaseHelper myHelper = new MyDatabaseHelper(
				  YouHuiShangXian_TeHui2.this, "techown.db", Constant.tdshDBVer);
			...
			while (cursor.moveToNext()) {
				try {
					...
					techown.shanghu.https.Log.Instance().WriteLog("YouHuiShangXian_TeHui2:读取数据" + e.getMessage());
				}finally{
					if(cursor!=null){
						cursor.close();
					}if(db!=null){
...
//        
    ...
    class MyLis implements OnClickListener{
		...
		public void onClick(View v) {
			...
			switch(id){
				case R.id.button2:					
					intent.setClass(YouHuiShangXian_TeHui2.this, YouHuiShangXian_TeHui.class);
					YouHuiShangXian_TeHui2.this.startActivity(intent);
					YouHuiShangXian_TeHui2.this.finish();
				...
				case R.id.button3:
					if(textView6.getText().toString().equals("0")||textView7.getText().toString().equals("0")){
						log.Toast(YouHuiShangXian_TeHui2.this, "GPS采集错误");
					}   
					else 
						if(textView6.getText().toString().equals("")||textView7.getText().toString().equals("")){
						log.Toast(YouHuiShangXian_TeHui2.this, "经纬度不能为空");
					}
					else{
					...
					handler.sendMessage(msg);//
					 new Thread(){
						 public void run(){
							 ...
							 str1[1]=YouHuiShangXian_TeHui.actid1;
							
							 String json1="{" +
				 				"\"merId\":\""+str1[0]+"\"," +
				 				"\"actId\":\""+str1[1]+"\"}";	
							 
							 YouHuiShangXian_TeHui4.requeststr1=HttpConnection2.request(json1,"A0010");
							
							 String Jsonstr = "{\"merId\":\""+YouHuiShangXian_TeHui.Id+"\",\"imgType\":\"00\"}";//3634d08337da5b8f0137da5bd77a0020
							 YouHuiShangXian_TeHui4.jsont=HttpConnection2.HttpRequest(HttpConnection2.getHttpCon(TuanDuiShangHuActivity.indenty,"A0018"), Jsonstr);
//
					
							 mDialog.dismiss();	
					saveData();
					intent.setClass(YouHuiShangXian_TeHui2.this, YouHuiShangXian_TeHui4.class);
					YouHuiShangXian_TeHui2.this.startActivity(intent);
					YouHuiShangXian_TeHui2.this.finish();
...
//					}
    	...
    	public void run() {
    		...
    		while(true){
    			...
    			if(currTime - startTime > 300000 && !isGetGps){
    				YouHuiShangXian_TeHui2.this.handler.sendEmptyMessage(7);
    				break;
    			}
	    		try{
	    			...
	    			techown.shanghu.https.Log.Instance().WriteLog("YouHuiShangXian_TeHui2:1000" + e.getMessage());
	    		}
    		}
    	}
    ...
    public void saveData() {
		...
		DB.upload4(YouHuiShangXian_TeHui2.this, clomname, clomstr, YouHuiShangXian_TeHui.num);
	}
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			log.ExitApp(YouHuiShangXian_TeHui2.this);
			break;
		...
		llistener = new LocationListener() {
			...
			// TODO Auto-generated method stub
				if(arg0 != null){
					...
					YouHuiShangXian_TeHui2.this.handler.sendEmptyMessage(6);
				}
