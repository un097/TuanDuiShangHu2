...
public class RedPictureDialog {
	...
	public RedPictureDialog(Context context,Bitmap bit,String picname){
...
//		dlg.setCanceledOnTouchOutside(true);// 设置点击Dialog外部任意区域关
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((RedTakePhotoActivity)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((RedTakePhotoActivity)context).startActivityForResult(i, 4);
...
//				((RedTakePhotoActivity)context).startActivityForResult(i, 4);
				...
				RedTakePhotoActivity.request =4;
//			}
