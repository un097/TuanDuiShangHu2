...
public class CopyOfYHPictureDialog {
	Dialog dlg;
	...
	public CopyOfYHPictureDialog(Context context,Bitmap bit,String picname){
...
//		preview.setRotation(270);
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((COfCOfYHTakePhotoActivity)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((COfCOfYHTakePhotoActivity)context).startActivityForResult(i, 4);
...
//				((COfCOfYHTakePhotoActivity)context).startActivityForResult(i, 4);
				...
				COfCOfYHTakePhotoActivity.request =4;
//			}
