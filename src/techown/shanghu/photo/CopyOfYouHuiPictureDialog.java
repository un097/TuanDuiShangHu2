...
public class CopyOfYouHuiPictureDialog {
	Dialog dlg;
	...
	public CopyOfYouHuiPictureDialog(Context context,Bitmap bit,String picname){
...
//		preview.setRotation(270);
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((CopyOfYouHuiTakePhotoActivity)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((CopyOfYouHuiTakePhotoActivity)context).startActivityForResult(i, 4);
...
//				((CopyOfYouHuiTakePhotoActivity)context).startActivityForResult(i, 4);
				...
				CopyOfYouHuiTakePhotoActivity.request =4;
//			}
