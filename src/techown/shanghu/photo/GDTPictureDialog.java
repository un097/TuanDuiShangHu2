...
public class GDTPictureDialog {
	...
	public GDTPictureDialog(Context context,Bitmap bit,String picname){
...
//		preview.setRotation(270);
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((GDTPhotoActivity)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((GDTPhotoActivity)context).startActivityForResult(i, 4);
