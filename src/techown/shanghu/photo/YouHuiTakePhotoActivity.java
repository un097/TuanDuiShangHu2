...
//		etlayout4=(LinearLayout)findViewById(R.id.etlayout4);
		...
		etlayout1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				log.etDialog(YouHuiTakePhotoActivity.this, textview1,R.id.editText1,"请输入收银台卡/跳跳卡数量");
			}
		});
		...
		etlayout2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				log.etDialog(YouHuiTakePhotoActivity.this, textview2,R.id.editText2,"请输入海报/宣传贴数量");
			}
		});
		etlayout3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				log.etDialog(YouHuiTakePhotoActivity.this, textview3,R.id.editText3,"请输入门贴/其他数量");
			}
		});
...
//    			{
					...
					b.setPositiveButton("确定", new DialogInterface.OnClickListener() {// 设置监听事件
								public void onClick(DialogInterface dialog, int which) {
									...
									techown.shanghu.https.OperateLog.Instance().WriteLog("商户团队特惠上线提交成功！");
									YouHuiTakePhotoActivity.this.finish();
								}
							});
...
//    				new AlertDialog.Builder(YouHuiTakePhotoActivity.this).setTitle("提示").setMessage("提交成功")
...
//    				}).show();
    		...
    		case R.id.chaogaoxiang:
				...
				.Instance()
				.WriteLog(
						"团队：特惠上线进入草稿箱 "+YouHuiShangXian_TeHui.num
								);
    			break;
...
//				}
    ...
    public void saveFile(String filepath, String fileName,int num){
		try
		{
			...
			techown.shanghu.https.Log.Instance().WriteLog("团队YouHuiTakePhotoActivity:"+e.getMessage());	
		}
		...
		public Context mContext;
		 ...
		 public ImageAdapter(Context con,String[]itemList,Bitmap[]bit)
		 {
	        ...
	        public View getView(int position, View convertView, ViewGroup parent) {
	            ...
	            {            	
	            	photoName.setText("门贴/其他拍照"+String.valueOf(Integer.parseInt(mItemList[position].split("_")[2])+1));
	            }
...
//    	DBUtil.upload4(YouHuiTakePhotoActivity.this, clomname, clomstr, YouHuiShangXian_TeHui.num);
 ...
 protected boolean validate() {
    	...
    	if(!takephoto1.getText().toString().equals("收银台卡/跳跳卡拍摄(已拍)")){
    		...
    		log.Toast(YouHuiTakePhotoActivity.this, "请拍摄 收银台卡/跳跳卡！");
    		return false;
    	}
    	if(!takephoto2.getText().toString().equals("海报/宣传贴拍摄(已拍)")){

    		log.Toast(YouHuiTakePhotoActivity.this, "请拍摄海报/宣传贴！");
    		return false;
    	}
    	if(textview1.getText().toString().equals("")){

    		log.Toast(YouHuiTakePhotoActivity.this, "收银台卡/跳跳卡数量不可为空");
    		return false;
    	}

    	if(textview1.getText().toString().equals("0")){

    		log.Toast(YouHuiTakePhotoActivity.this, "收银台卡/跳跳卡数量不可为0！");
    		return false;
    	}
    	if(textview2.getText().toString().equals("")){

    		log.Toast(YouHuiTakePhotoActivity.this, "海报/宣传贴数量不可为空");
    		return false;
    	}

    	if(textview2.getText().toString().equals("0")){

    		log.Toast(YouHuiTakePhotoActivity.this, "海报/宣传贴数量不可为0！");
    		return false;
    	}

    	if(textview3.getText().toString().equals("0")){

    		log.Toast(YouHuiTakePhotoActivity.this, "门贴/其他数量不可为0！");
    		return false;
    	}
    	if(!log.isNumber(textview1.getText().toString())){

	 		log.Toast(YouHuiTakePhotoActivity.this, "数量只可为数字且首位不可为0！");
	 		return false;
	 	}
