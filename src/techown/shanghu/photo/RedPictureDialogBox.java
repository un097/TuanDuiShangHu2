...
public class RedPictureDialogBox {
	Dialog dlg;
	...
	public RedPictureDialogBox(Context context,Bitmap bit,String picname){
	...
	public void showListDialog() {
		...
		// 得到自定义对话框
		View DialogView = (View)factory.inflate(R.layout.paizhao1, null);
		DialogView.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,LayoutParams.FILL_PARENT));
...
//		dlg.setCanceledOnTouchOutside(true);// 设置点击Dialog外部任意区域关
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((RedTakePhotoActivityBox)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((RedTakePhotoActivityBox)context).startActivityForResult(i, 4);
...
//				((RedTakePhotoActivityBox)context).startActivityForResult(i, 4);
				...
				RedTakePhotoActivityBox.request =4;
//			}
