...
//	boolean isdelete;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mDialog = new AlertDialog.Builder(TakePhotoActivity.this).create();
...
//				if(!HeYueQianDing_2.tempstr1[17].equals("")){
...
//					huihui=2;
		...
		ia = new ImageAdapter(TakePhotoActivity.this, picname, picbim);
		imageList.setAdapter(ia);
		imageList.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				PictureDialog editDlg = new PictureDialog(
						TakePhotoActivity.this, ia.mbit[arg2],
						ia.mItemList[arg2]);
	...
	class testBtnListener implements OnClickListener {
		public void onClick(View v) {
			...
			case R.id.takephoto_before:// 存入草稿箱
				uploadname();
				log.ExitApp2(TakePhotoActivity.this);
				techown.shanghu.https.Log
				.Instance()
				.WriteLog(
						"团队：合约签订进入草稿箱 "+TuanDuiShangHuActivity.num
								);
				break;
			case R.id.button6:// 提交
				if (takephoto1.getText().toString().equals("营业执照拍摄(已拍)") &&
					...
					DB.sendinsert(TakePhotoActivity.this, new String[] {
							MyDatabaseHelper.SEND_BarcodeNo,
							MyDatabaseHelper.BEGINNUM,
							MyDatabaseHelper.TOTALNUM }, new String[] {
							barcodeno, "1", "0" });
					//
					Builder b = new AlertDialog.Builder(TakePhotoActivity.this);
					b.setTitle("提示");
					...
					b.setPositiveButton("确定", new DialogInterface.OnClickListener() {// 设置监听事件
								public void onClick(DialogInterface dialog, int which) {
									...
									techown.shanghu.https.OperateLog.Instance().WriteLog("商户团队合约签订提交成功！");
...
//							"请您检查营业执照和盖章协议是否已拍摄！", 3).show();
					log.Toast(TakePhotoActivity.this, "请您检查营业执照和盖章协议是否已拍摄！");
				}
				break;
			case R.id.button7:// 返回
				uploadname();
				Intent intent = new Intent();
				intent.setClass(TakePhotoActivity.this,HeYueQianDing_5.class);
...
//			bitmap = (Bitmap) extras.get("data");
	...
	public void saveData() {
		...
		DB.upload(TakePhotoActivity.this, clomname, clomstr,
	...
	private void uploadname() {
		...
		if (picname != null && picname.length > 0) {
			...
			DB.upload(TakePhotoActivity.this, new String[] { "AttLicense",
	...
	public boolean validate() {
    	...
    	if(!takephoto1.getText().toString().equals("营业执照拍摄(已拍)")){
//    		Toast.makeText(TakePhotoActivity.this, "请拍摄营业执照！", Toast.LENGTH_SHORT)
//			.show();
    		log.Toast(TakePhotoActivity.this, "请拍摄营业执照！");
    		return false;
    	}
    	if(!takephoto2.getText().toString().equals("盖章协议拍摄(已拍)")){
//    		Toast.makeText(TakePhotoActivity.this, "请拍摄盖章协议！", Toast.LENGTH_SHORT)
//			.show();
    		log.Toast(TakePhotoActivity.this, "请拍摄盖章协议！");
    		return false;
    	}
    ...
    private void guolaipaizhao() {
    	...
    	try
    	{
    		MyDatabaseHelper myHelper = new MyDatabaseHelper(TakePhotoActivity.this, "techown.db", Constant.tdshDBVer);
	...
	public void tiaoxingma() {
		...
		try
		{
			MyDatabaseHelper myHelper = new MyDatabaseHelper(
					TakePhotoActivity.this, "techown.db", Constant.tdshDBVer);
			db = myHelper.getWritableDatabase();
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			log.ExitApp(TakePhotoActivity.this);
			break;
