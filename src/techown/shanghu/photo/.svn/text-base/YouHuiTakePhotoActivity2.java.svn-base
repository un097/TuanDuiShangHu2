...
//				etlayout4=(LinearLayout)findViewById(R.id.etlayout4);
				...
				etlayout1.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						// TODO Auto-generated method stub
						log.etDialog(YouHuiTakePhotoActivity2.this, textview1,R.id.editText1,"请输入展架数量");
					}
				});
				...
				etlayout3.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						// TODO Auto-generated method stub
						log.etDialog(YouHuiTakePhotoActivity2.this, textview3,R.id.editText3,"请输入其他文宣数量");
					}
				});
...
//		    			{
							...
							b.setPositiveButton("确定", new DialogInterface.OnClickListener() {// 设置监听事件
										public void onClick(DialogInterface dialog, int which) {
											...
											techown.shanghu.https.OperateLog.Instance().WriteLog("商户团队最红上线提交成功！");
											YouHuiTakePhotoActivity2.this.finish();
										}
									});
...
//							new AlertDialog.Builder(YouHuiTakePhotoActivity2.this).setTitle("提示").setMessage("提交成功")
...
//							}).show();
		    		...
		    		case R.id.button6:
						...
						.Instance()
						.WriteLog(
								"团队：最后上线进入草稿箱 "+YouHuiShangXian_TeHui.num
										);
		    			break;
...
//						}
		    ...
		    public void saveFile(String filepath, String fileName,int num){
				try
				{
					...
					techown.shanghu.https.Log.Instance().WriteLog("团队YouHuiTakePhotoActivity2:"+e.getMessage());		
				}
...
//		    	System.out.println("保存草稿箱的时间+ 最红上线  +="+time);
...
//							
		    ...
		    protected boolean validate() {
		    	...
		    	if(textview1.getText().toString().equals("")){
		    		...
		    		log.Toast(YouHuiTakePhotoActivity2.this, "展架数量不可为空");
		    		return false;
		    	}
		    	if(!log.allowMaxLenthOfString(textview1.getText().toString(), 10)){

		    		log.Toast(YouHuiTakePhotoActivity2.this, "展架数量必须小于10位！");
		    		return false;
		    	}

		    	if(!log.allowMaxLenthOfString(textview3.getText().toString(), 10)){

		    		log.Toast(YouHuiTakePhotoActivity2.this, "其他文宣数量必须小于10位！");
		    		return false;
		    	}

		    	if(!takephoto1.getText().toString().equals("展架拍摄(已拍)")){

		    		log.Toast(YouHuiTakePhotoActivity2.this, "请拍摄展架照！");
		    		return false;
		    	}
		    	if(!log.isNumber(textview1.getText().toString())){

			 		log.Toast(YouHuiTakePhotoActivity2.this, "数量只可为数字且首位不可为0！");
			 		return false;
			 	}
