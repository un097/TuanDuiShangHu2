...
import techown.shanghu.SHGongDanWeiHu_4;
 ...
 *
 */
public class SHGDPictureDialog {
	Dialog dlg;
	...
	public SHGDPictureDialog(Context context,Bitmap bit,String picname){
...
//		dlg.setCanceledOnTouchOutside(true);// 设置点击Dialog外部任意区域关
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((SHGongDanWeiHu_4)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
