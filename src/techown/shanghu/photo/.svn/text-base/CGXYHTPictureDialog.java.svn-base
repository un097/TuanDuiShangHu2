...
public class CGXYHTPictureDialog {
	Dialog dlg;
	...
	public CGXYHTPictureDialog(Context context,Bitmap bit,String picname){
...
//		preview.setRotation(270);
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((CGXYHTakePhotoActivity)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((CGXYHTakePhotoActivity)context).startActivityForResult(i, 4);
...
//				((CGXYHTakePhotoActivity)context).startActivityForResult(i,4);
				...
				CGXYHTakePhotoActivity.request =4;
//			}
