...
import techown.shanghu.HeYueQianDing_21;
import techown.shanghu.HeYueQianDing_51;
import techown.shanghu.MyDatabaseHelper;
import techown.shanghu.PadUtiltiy;
import techown.shanghu.R;
import techown.shanghu.ShangHuChaXun;
...
//	boolean isdelete;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		path = "TJB/TuanDui/shang/" + TuanDuiShangHuActivity.num + "/pic/";
		createDir(path);
		guolaipaizhao();
		mPadUtiltiy = new PadUtiltiy(this);
		mDialog = new AlertDialog.Builder(TakePhotoActivity2.this).create();
		...
		takephoto1 = (Button) findViewById(R.id.takephoto1);
			 ...
			 if(ShangHuChaXun.a==1){
				if(!HeYueQianDing_21.tempstr1[17].equals("")){
...
//								Intent i = new Intent();
//					    		i.setClass(TakePhotoActivity2.this, CaptureImage.class);
...
//						}
		...
		ia = new ImageAdapter(TakePhotoActivity2.this, picname, picbim);
		imageList.setAdapter(ia);
		imageList.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				PictureDialog5 editDlg = new PictureDialog5(
						TakePhotoActivity2.this, ia.mbit[arg2],
						ia.mItemList[arg2]);
	...
	class testBtnListener implements OnClickListener {
		public void onClick(View v) {
			...
			case R.id.takephoto_before:// 存入草稿箱
				saveData();
				log.ExitAppTake(TakePhotoActivity2.this);
				techown.shanghu.https.Log
				.Instance()
				.WriteLog(
						"团队：合约签订(拒件)进入草稿箱 "+TuanDuiShangHuActivity.num
								);
				break;
			case R.id.button6:// 提交
				...
				if (takephoto1.getText().toString().equals("营业执照拍摄(已拍)") &&
					...
					DB.sendinsert(TakePhotoActivity2.this, new String[] {
							MyDatabaseHelper.SEND_BarcodeNo,
							MyDatabaseHelper.BEGINNUM,
							MyDatabaseHelper.TOTALNUM }, new String[] {
							barcodeno, "1", "0" });
				
					Builder b = new AlertDialog.Builder(TakePhotoActivity2.this);
					b.setTitle("提示");
					...
					b.setPositiveButton("确定", new DialogInterface.OnClickListener() {// 设置监听事件
								public void onClick(DialogInterface dialog, int which) {
									...
									intent.setClass(
											TakePhotoActivity2.this,
											TuanDuiShangHuActivity.class);
									TakePhotoActivity2.this
											.startActivity(intent);
									techown.shanghu.https.OperateLog.Instance().WriteLog("商户团队商户查询拒件提交成功！");
...
//					new AlertDialog.Builder(TakePhotoActivity2.this)
//							.setTitle("提示")
//							.setMessage("提交成功")
...
//							"请您检查营业执照和盖章协议是否已拍摄！", 3).show();
					log.Toast(TakePhotoActivity2.this, "请您检查营业执照和盖章协议是否已拍摄！");
				}
				break;
			case R.id.button7:// 返回
				uploadname();
				Intent intent = new Intent();
				intent.setClass(TakePhotoActivity2.this, HeYueQianDing_51.class);
				TakePhotoActivity2.this.startActivity(intent);
				TakePhotoActivity2.this.finish();
...
//				huihui++;
			...
			techown.shanghu.https.Log.Instance().WriteLog("团队TakePhotoActivity2:"+e.getMessage());	
		}
...
//			}	
	...
	public void saveData() {
		...
		DB.upload(TakePhotoActivity2.this, clomname, clomstr,
	...
	public  void saveData1(Context con) {
		...
		clomstr[2] = time;
		clomstr[3] = bb;
		System.out.println("保存时的时间++++++++++"+time);
		DB.upload(con, clomname, clomstr, TuanDuiShangHuActivity.num);
	...
	private void uploadname() {
		...
		if (picname != null && picname.length > 0) {
			...
			DB.upload(TakePhotoActivity2.this, new String[] { "AttLicense",
...
//			.show();
    ...
    private void guolaipaizhao() {
    	...
    	try
    	{
    		MyDatabaseHelper myHelper = new MyDatabaseHelper(TakePhotoActivity2.this, "techown.db", Constant.tdshDBVer);
    		db = myHelper.getWritableDatabase();
    		cursor = db.rawQuery("select * from st_storeinfo where id==?",new String[] { TuanDuiShangHuActivity.num});
    		while (cursor.moveToNext()) {
    			try {
    				...
    				AttAccredit = des.jieMI(cursor.getString(cursor.getColumnIndex("AttAccredit")));
    				AttOthers = des.jieMI(cursor.getString(cursor.getColumnIndex("AttOthers")));
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			log.ExitApp(TakePhotoActivity2.this);
			break;
