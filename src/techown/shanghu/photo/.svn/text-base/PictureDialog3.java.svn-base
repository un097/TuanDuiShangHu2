...
public class PictureDialog3 {
	...
	public PictureDialog3(Context context,Bitmap bit,String picname){
...
//		preview.setRotation(270);
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((YouHuiTakePhotoActivity2)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((YouHuiTakePhotoActivity2)context).startActivityForResult(i, 4);
...
//				((YouHuiTakePhotoActivity2)context).startActivityForResult(i, 4);
				...
				YouHuiTakePhotoActivity2.request =4;
//			}
