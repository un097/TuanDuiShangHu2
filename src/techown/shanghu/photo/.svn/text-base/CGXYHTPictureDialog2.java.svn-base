...
public class CGXYHTPictureDialog2 {
	Dialog dlg;
	...
	public CGXYHTPictureDialog2(Context context,Bitmap bit,String picname){
...
//		preview.setRotation(270);
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((CGXYHTakePhotoActivity2)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((CGXYHTakePhotoActivity2)context).startActivityForResult(i, 4);
...
//				((CGXYHTakePhotoActivity2)context).startActivityForResult(i, 4);
				...
				CGXYHTakePhotoActivity2.request =4;
//			}
