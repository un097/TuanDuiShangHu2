...
public class PictureDialog_1_5 {
	Dialog dlg;
	...
	public PictureDialog_1_5(Context context,Bitmap bit,String picname){
...
//		preview.setRotation(270);
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((TakePhotoActivity_1_5)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((TakePhotoActivity_1_5)context).startActivityForResult(i, 4);
...
//				((TakePhotoActivity_1_5)context).startActivityForResult(i, 4);
				...
				TakePhotoActivity_1_5.request =4;
//			}
