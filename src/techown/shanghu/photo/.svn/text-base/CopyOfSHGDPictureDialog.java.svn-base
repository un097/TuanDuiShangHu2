...
import techown.shanghu.CGXSHGongDanWeiHu_42;
 ...
 *
 */
public class CopyOfSHGDPictureDialog {
	Dialog dlg;
	...
	public CopyOfSHGDPictureDialog(Context context,Bitmap bit,String picname){
...
//		dlg.setCanceledOnTouchOutside(true);// 设置点击Dialog外部任意区域关
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((CGXSHGongDanWeiHu_42)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((TakePhotoActivity)context).startActivityForResult(i, 4);
...
//				((TakePhotoActivity)context).startActivityForResult(i, 4);
				...
				CGXSHGongDanWeiHu_42.request =4;
//			}
