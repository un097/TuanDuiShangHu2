...
public class PictureDialog2 {
	...
	public PictureDialog2(Context context,Bitmap bit,String picname){
...
//		preview.setRotation(270);
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((YouHuiTakePhotoActivity)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((YouHuiTakePhotoActivity)context).startActivityForResult(i, 4);
...
//				((YouHuiTakePhotoActivity)context).startActivityForResult(i, 4);
				...
				YouHuiTakePhotoActivity.request =4;
//			}
			
			
//			Intent i=new Intent("android.media.action.IMAGE_CAPTURE");
//			((YouHuiTakePhotoActivity)context).startActivityForResult(i, 5);
