...
public class RedTakePhotoActivity extends Activity {
...
//	boolean isdelete;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		path = "TJB/TuanDui/redwu/" + TuanDuiShangHuActivity.num + "/pic/";
		createDir(path);
		guolaipaizhao();
		tiaoxingma();
		mPadUtiltiy = new PadUtiltiy(this);
		mDialog = new AlertDialog.Builder(RedTakePhotoActivity.this).create();
...
//						}
		...
		ia = new ImageAdapter(RedTakePhotoActivity.this, picname, picbim);
		imageList.setAdapter(ia);
		imageList.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				RedPictureDialog editDlg = new RedPictureDialog(
						RedTakePhotoActivity.this, ia.mbit[arg2],
						ia.mItemList[arg2]);
		...
		public void onClick(View v) {
			...
			case R.id.button6:// 提交
				if (takephoto1.getText().toString().equals("营业执照拍摄(已拍)") &&
					...
					DB.sendinsert(RedTakePhotoActivity.this, new String[] {
							MyDatabaseHelper.SEND_BarcodeNo,
							MyDatabaseHelper.BEGINNUM,
							MyDatabaseHelper.TOTALNUM }, new String[] {
							barcodeno, "1", "0" });
					//
					Builder b = new AlertDialog.Builder(RedTakePhotoActivity.this);
					b.setTitle("提示");
					...
					log.Toast(RedTakePhotoActivity.this, "请您检查营业执照和盖章协议是否已拍摄！");
				}
				break;
			case R.id.button7:// 返回
				uploadname();
				Intent intent = new Intent();
				intent.setClass(RedTakePhotoActivity.this,RedActivityMessage.class);
				RedTakePhotoActivity.this.startActivity(intent);
				RedTakePhotoActivity.this.finish();
...
//				huihui=2;
			...
			techown.shanghu.https.Log.Instance().WriteLog("团队RedTakePhotoActivity:"+e.getMessage());		
		}
...
//	    		}
	...
	class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			LayoutInflater inflater = LayoutInflater
					.from(RedTakePhotoActivity.this);
	...
	public void saveData() {
		...
		DB.Red_upload(RedTakePhotoActivity.this, clomname, clomstr,
	...
	public  void saveData1(Context con) {
		...
		DB.Red_upload(con, clomname, clomstr, TuanDuiShangHuActivity.num);
	...
	private void uploadname() {
		...
		if (picname != null && picname.length > 0) {
			...
			{
				if(TakePhoneName!=null&&TakePhoneName.toString().length()>0)
				{
		...
		DB.Red_upload(RedTakePhotoActivity.this, new String[] { "TakePhoneName"},
	...
	public boolean validate() {
    	...
    	if(!takephoto1.getText().toString().equals("营业执照拍摄(已拍)")){
    		log.Toast(RedTakePhotoActivity.this, "请拍摄营业执照！");
    		return false;
    	}
    	if(!takephoto2.getText().toString().equals("盖章协议拍摄(已拍)")){
    		log.Toast(RedTakePhotoActivity.this, "请拍摄盖章协议！");
    		return false;
    	}
    ...
    private void guolaipaizhao() {
    	...
    	try
    	{
    		MyDatabaseHelper myHelper = new MyDatabaseHelper(RedTakePhotoActivity.this, "techown.db", Constant.tdshDBVer);
    		db = myHelper.getWritableDatabase();
    		cursor = db.rawQuery("select * from red_enterletter where id==?",new String[] { TuanDuiShangHuActivity.num});
	...
	public void tiaoxingma() {
		...
		try
		{
			MyDatabaseHelper myHelper = new MyDatabaseHelper(
					RedTakePhotoActivity.this, "techown.db", Constant.tdshDBVer);
			db = myHelper.getWritableDatabase();
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			log.ExitApp(RedTakePhotoActivity.this);
			break;
