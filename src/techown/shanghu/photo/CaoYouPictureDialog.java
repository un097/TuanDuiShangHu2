...
public class CaoYouPictureDialog {
	Dialog dlg;
	...
	public CaoYouPictureDialog(Context context,Bitmap bit,String picname){
...
//		preview.setRotation(270);
	...
	class deleteBtnListener implements OnClickListener{
		public void onClick(View v) {
			...
			((CaoYouHuiTakePhotoActivity2)context).handlerphoto.sendMessage(msg);
			dlg.dismiss();
		}
	}
...
//				((CaoYouHuiTakePhotoActivity2)context).startActivityForResult(i, 4);
...
//				((CaoYouHuiTakePhotoActivity2)context).startActivityForResult(i, 4);
				...
				CaoYouHuiTakePhotoActivity2.request =4;
//			}
			dlg.dismiss();
