...
//	String[] province;
	...
	public String cgRefuseMenInfoCityId;//此页面对应的城市Id
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
//		province = DB.klQuery(HeYueQianDing_31_3.this, "Name", "t_province");
		
//        List<TArea> tareaList1=DB.klQuery(HeYueQianDing_31_3.this,"t_childtyp");
...
//        }
//      
//		tareaList = DB.klQuery(HeYueQianDing_31_3.this,
//				"t_category");
...
//        typename = DB.klQuery(HeYueQianDing_31_3.this, "typeCode", "t_mertype");

        typename = DB.klQuery21(HeYueQianDing_31_3.this, "typeCode", "typeNum", "t_mertype");
		...
		Cursor cur =null;
		try {
			friendContext = HeYueQianDing_31_3.this.createPackageContext("techown.login",
		...
		{
			techown.shanghu.https.Log.Instance().WriteLog("团队HeYueQianDing_31_3:"+e.getMessage());
		}finally{
			if(cur != null){
				cur.close();
			}if(sld != null){
		...
		*/
		cgRefuseMenInfoCityId = TuanDuiShangHuActivity.cityId;
...
//        MyDatabaseHelper myHelper1 = new MyDatabaseHelper(
//				HeYueQianDing_3.this, "techown.db", 1);
//		SQLiteDatabase db1 = myHelper1.getWritableDatabase();
//		Cursor cursor1 = db1.rawQuery("select * from st_storeinfo where id==?",
//				new String[] { TuanDuiShangHuActivity.num });
//		textArray[1].setText(cursor1.getString(cursor1
//				.getColumnIndex("merName")));
//		textArray[4].setText(cursor1.getString(cursor1
//				.getColumnIndex("adress")));
//		textArray[13].setText(cursor1.getString(cursor1
//				.getColumnIndex("contacter")));
//		textArray[14].setText(cursor1.getString(cursor1
//				.getColumnIndex("contactTel")));
		
		SQLiteDatabase db=null;
		Cursor cursor=null;
		try {
        MyDatabaseHelper myHelper = new MyDatabaseHelper(
				HeYueQianDing_31_3.this, "techown.db", Constant.tdshDBVer);
		...
		while (cursor.moveToNext()) {
				...
				zihangye = des.jieMI(cursor.getString(cursor
...
//				textArray[19].setText(id3);
				 ...
				 * 记录城市Id
				 */
				cgRefuseMenInfoCityId = des.jieMI(cursor.getString(cursor
						.getColumnIndex("CityId")));

				h1et702.setText(des.jieMI(cursor.getString(cursor
						.getColumnIndex("CityId"))));
				//城市名称
				String chengshiname = DB.queryCityname(HeYueQianDing_31_3.this, h1et702.getText().toString());
...
//				String Dnum=cursor.getString(cursor
//						.getColumnIndex("Dnum"));
//				if(Dnum.equals("1")){
		...
		linlay[20].setEnabled(true);
			...
			techown.shanghu.https.Log.Instance().WriteLog("团队HeYueQianDing31_3:"+e.getMessage());
		}
		finally{
			if(cursor!=null)
				cursor.close();
		...
		String id3 = DB.klQueryCity1(this, "t_category",
				"where Id = '" + des.jiaMi(textArray[19].getText().toString())
						+ "'");
		textArray[19].setText(id3);
		String name1=DB.klQueryCity1(this, "t_district", "where Id = '"
				+ des.jiaMi(h1et703.getText().toString()) + "'");
				h1et703.setText(name1);
		...
		h1leout73.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				{
				/*String[] str1 = getDasta.getCity11(HeYueQianDing_31_3.this,
						h1et702.getText().toString());*/
				String[] str1 = getDasta.getCity12(HeYueQianDing_31_3.this,
							cgRefuseMenInfoCityId);
				if (str1.length > 0) {
					dialog.dialog(HeYueQianDing_31_3.this, h1et703, "区",
							str1);
				} else {
					h1et703.setText("无");
				...
				{
					dialog.Toast(HeYueQianDing_31_3.this, "请选择城市！");
				}
			}
		});
		...
		linlay[4].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				case MotionEvent.ACTION_UP:
					dialog.etDialog(HeYueQianDing_31_3.this, textArray[4],
		...
		linlay[5].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				case MotionEvent.ACTION_UP:
					...
					dialog.num = 2;
					// lxp
					 dialog.dialog2(HeYueQianDing_31_3.this, textArray[5],"主行业", name);
					 h2edtext222.setText("");
		...
		linlay[6].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.dialog(HeYueQianDing_31_3.this, textArray[6], "菜系",
							t_childtyp);
					break;
				default:
					break;
			...
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				case MotionEvent.ACTION_UP:
					if(h1et702.getText().toString().length()>0)
					{
						...
						String[] t_trading1 = queryTradingNameByCityId(cgRefuseMenInfoCityId);
						if(t_trading1!=null&&t_trading1.length>0)
						{
							dialog.dialog(HeYueQianDing_31_3.this, textArray[7], "商圈",
									t_trading1);
						}
						else
						{
							dialog.Toast(HeYueQianDing_31_3.this, "该城市没有商圈！");
						}
					}
					else
					{
						dialog.Toast(HeYueQianDing_31_3.this, "请先选择城市！");
					}
					break;
				default:
					break;
...
//		});
		linlay[10].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.etDialog(HeYueQianDing_31_3.this, textArray[10],
...
//							R.id.h2edtext12);
					dialog.etDialog(HeYueQianDing_31_3.this, textArray[11],R.id.h2edtext12,"请输入纬度");
					break;
				default:
					break;
				}
...
//		});
		linlay[13].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.etDialog(HeYueQianDing_31_3.this, textArray[13],
		...
		linlay[14].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.etDialog(HeYueQianDing_31_3.this, textArray[14],
        ...
        linlay[15].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				case MotionEvent.ACTION_UP:
					...
					dialog.dialog(HeYueQianDing_31_3.this, textArray[15],
							"类型", province1);
					break;
				default:
					break;
        ...
        linlay[16].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				case MotionEvent.ACTION_UP:
					...
					dialog.num = 1;
					// lxp
					dialog.dialog(HeYueQianDing_31_3.this, textArray[16],
							"类型", province);
					break;
				default:
					break;
        ...
        linlay[17].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					DateDialog.showDatePicker(HeYueQianDing_31_3.this,
        ...
        linlay[18].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.etDialog(HeYueQianDing_31_3.this, textArray[18],
        ...
        linlay[19].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.dialog(HeYueQianDing_31_3.this, textArray[20],
							"类型", bb);
					break;
				default:
					break;
        ...
        linlay[20].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.Dialog(HeYueQianDing_31_3.this, linlay[20],textArray[21],
        ...
        linlay[21].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.Dialog(HeYueQianDing_31_3.this, linlay[21],textArray[22],
							R.id.h2edtext21,"请输入注备1");
					break;
				default:
					break;
				}
        ...
        linlay[22].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.Dialog(HeYueQianDing_31_3.this, linlay[22],textArray[23],
							R.id.h2edtext21,"请输入注备2");
					break;
				default:
					break;
				}
        ...
        linlay[23].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.Dialog(HeYueQianDing_31_3.this, linlay[23],textArray[24],
							R.id.h2edtext21,"请输入注备3");
					break;
				default:
					break;
				}
        ...
        linlay[24].setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View arg0, MotionEvent arg1) {
				switch (arg1.getAction()) {
				case MotionEvent.ACTION_UP:
					dialog.Dialog(HeYueQianDing_31_3.this, linlay[24],textArray[25],
							R.id.h2edtext21,"请输入注备4");
					break;
				default:
					break;
				}
    	...
    	techown.shanghu.https.Log.Instance().WriteLog("HeYueQianDing_31_3类："+e.getMessage());
    }
    }
    ...
    public void init()
    {
		...
		textArray[12].setText(contacter);//联系人
				    	...
				    	for (int i = 1; i < arrg.length; i++) {
				    		...
				    		View view = LayoutInflater.from(HeYueQianDing_31_3.this).inflate(
        	...
        	techown.shanghu.https.Log.Instance().WriteLog("HeYueQianDing_31_3类init()："+e.getMessage());
	...
	class MyLis implements OnClickListener {
		...
		public void onClick(View v) {
			try {
				...
				if (validate()) {
						saveData();
						intent.setClass(HeYueQianDing_31_3.this, HeYueQianDing_41_4.class);
						HeYueQianDing_31_3.this.startActivity(intent);
						HeYueQianDing_31_3.this.finish();
					...
					intent.setClass(HeYueQianDing_31_3.this, HeYueQianDing_21_2.class);
					HeYueQianDing_31_3.this.startActivity(intent);
					HeYueQianDing_31_3.this.finish();
				...
				techown.shanghu.https.Log.Instance().WriteLog("HeYueQianDing_31_3类按钮点击："+e.getMessage());
	...
	public void saveData() {
		String[] clomname = new String[] { "StName", "Stel", "StAdress",
				...
				"StBillRate", "IsNewStore", "StLicense","Zhihangye","AreaId",
				"XuanChuan","PiceXuanChuan","CityId",
		...
		//String cityid = DB.queryCityid(HeYueQianDing_31_3.this, h1et702.getText().toString());
		clomstr[23] = cgRefuseMenInfoCityId;//城市
		
		clomstr[24] = textArray[22].getText().toString();//注备1
		clomstr[25] = textArray[23].getText().toString();//注备2
		clomstr[26] = textArray[24].getText().toString();//注备3
		clomstr[27] = textArray[25].getText().toString();//注备4
		...
		String id2=DB.klQueryCity(this, "t_trading", "where Name = '"
				+des.jiaMi(clomstr[6])+"' and CityId = '"+des.jiaMi(clomstr[23])+"'");
		clomstr[6] = id2;
		...
		DB.upload(HeYueQianDing_31_3.this, clomname, clomstr,
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			dialog.ExitApp(HeYueQianDing_31_3.this);
			break;
	...
	protected boolean validate() {
		if (h1et702.getText().toString().equals("")) {
			dialog.Toast(HeYueQianDing_31_3.this, "请选择门店所在城市 ！");
			return false;
		}
		if (textArray[20].getText().toString().equals("")) {
			dialog.Toast(HeYueQianDing_31_3.this, "请输入商户类型！");
			return false;
		}
		if (textArray[21].getText().toString().equals("")) {
			dialog.Toast(HeYueQianDing_31_3.this, "请输入白名单编号！");
			return false;
		}
		typCode[1]=textArray[20].getText().toString();
		String id3=DB.klQuerytypecode(HeYueQianDing_31_3.this, "t_mertype", "where typeCode = '"+des.jiaMi(typCode[1])+"'");
		typCode[1]=id3;
		String name = null;
		if(textArray[21].getText().toString().length()>=typCode[1].length()){
			name=textArray[21].getText().toString().substring(0, typCode[1].length());
		}else{
			dialog.Toast(HeYueQianDing_31_3.this, "白名单编号与商户类型不符！");
			return false;
		...
		if (textArray[19].getText().toString().equals("")) {
			...
			dialog.Toast(HeYueQianDing_31_3.this,   "请输入子行业 ！");
			return false;
		}
	return true;
}
	...
	public String queryCityName(String username) {
		...
		try {
			...
			if (cursor.getCount() == 1) {
				cursor.moveToLast();
				cityName = des.jieMI(cursor.getString(0));
			}
			
		} catch (Exception e) { 
			techown.shanghu.https.Log.Instance().WriteLog("HeYueQianDing_31_3类：queryCityName()"+e.getMessage());
		}finally{
			if(cursor != null){
				cursor.close();
			}if(db != null){
	...
	public String[] queryTradingNameByCityId(String cityid) {
		...
		try {
			...
			techown.shanghu.https.Log.Instance().WriteLog(
					"团队：HeYueQianDing_31-3queryTradingNameByCityId出错" + e.getMessage());
		} finally {
			if (cursor != null) {
				cursor.close();
			}
...
//					new String[] { cityId });
			...
			techown.shanghu.https.Log.Instance().WriteLog("HeYueQianDing_31_3类：queryTradingName()"+e.getMessage());
		}finally{
			if(cursor != null){
				cursor.close();
			}if(tmpCur != null){
